...
<body>
    %for o in objects :
        ...
        <% comment = set_notas(o) %>
        <% name = set_referencia(o) %>
        <% tipo = set_tipo(o) %>
        <% symbol = set_symbol(o) %>
        <% invoice_lines = set_global_invoice_line(o) %>
                    ...
                    <table class="basic_table">
                        <tr>
                            ...
                            <td width='20%'>
                                <div class="invoice">
                            ${tipo} 
                            ${ dict_data['@serie'] or _("sin serie")|entity} 
        ...
        <table class="basic_table" style="font-size:11;">
            <tr>
			    ...
			    <td width="7%" class="cliente"><b>O.C:</b></td>
                            <td width="15%" class="cliente">${name or ''}</td>
                        </tr>
                    </table>
                </td>
                <td width="1%"></td>
        ...
        <table class="basic_table" style="color:#121212">
            ...
            %else:
                <% dict_lines =  dict_data['Conceptos']['Concepto']%>
            %endif
	%for dict in invoice_lines:

		
                    <td width="10%" class="number_td">${ dict['cantidad']} </td>
                    <td width="10%" class="basic_td">${ dict['unidad']}  </td>
                    <td class="basic_td">${ dict['descripcion']}  </td>
                    <td width="9%" class="number_td">${ dict['precio_unitario']}  </td>
                    <td width="15%" class="number_td">${ dict['importe']} </td>
                    </tr>
                    % if dict['pedimentos']:
                    <tr>
                    ...
                    <tr class="firstrow">
                        <td width="10%" class="number_td">Aduana</td>
                        <td width="10%" class="number_td">Fecha Aduana</td>
                        <td width="10%" class="number_td">Numero Pedimento</td>
                    </tr>
                        %for pedimento in dict['pedimentos']:
                            <tr>
                                <td width="10%" class="number_td">${ pedimento['aduana']} </td>
                                <td width="10%" class="number_td">${ pedimento['fecha']} </td>
                                <td width="10%" class="number_td">${ pedimento['numero']} </td>
                            </tr>
        ...
        <table align="right" width="30%" style="border-collapse:collapse">
            <tr>
                ...
                <td align="right" class="total_td">${ symbol } ${ round(float(dict_data['@subTotal']),4) or ''|entity}</td>
            </tr>
            ...
            <tr align="left">
                ...
                <td class="total_td" align="right"><b>${ symbol } ${ dict_data['@total'] or ''|entity}</b></td>
            </tr>
        </table>
        <br clear="all" />
        <table class="basic_table">
